...
Ardublockly.isRunningElectron = function() {
  return navigator.userAgent.toLowerCase().indexOf('tBot') > -1;
};
...
(function loadJsInElectron(){
  if (Ardublockly.isRunningElectron()) {
    ...
    window.$ = window.jQuery = require(projectRoot +
        '/tBot/js_libs/jquery-2.1.3.min.js');
    window.Hammer = require(projectRoot + '/tBot/js_libs/hammer.min.js');
    window.JsDiff = require(projectRoot + '/tBot/js_libs/diff.js');
  }
})();
