...
class ServerTestCase(unittest.TestCase):
    ...
    def test_static_ardublockly(self):
        """Test the files in /tBot can be accessed."""
        self.helper_test_static_file('tBot', 'index.html')
    ...
    def test_index_redirect(self):
        """Test the root of the server redirects to tBot/index.html."""
        # Create tBot/index.html
        ardublockly_folder = os.path.join(self.temp_folder, 'tBot')
        ...
        self.assertEqual(response.url,
                         '%s/tBot/index.html' % self.SERVER_URL)
    ...
    def test_ardublockly_redirect(self):
        """Test the /tBot path redirects to tBot/index.html."""
        # Create tBot/index.html
        ardublockly_folder = os.path.join(self.temp_folder, 'tBot')
        os.makedirs(ardublockly_folder)
        open(os.path.join(ardublockly_folder, 'index.html'), 'w').close()

        response = requests.get(self.SERVER_URL + '/tBot')
